...
/** @event request */
class Server extends EventEmitter implements \React\Http\ServerInterface
{
    private $io;
    ...
    public function __construct(SocketServerInterface $io)
    {
        ...
        $this->io->on('connection', function (\React\Socket\Connection $conn) {
            // TODO: http 1.1 keep-alive
            // TODO: chunked transfer encoding (also for outgoing data)
            // TODO: multipart parsing

            $parser = new RequestHeaderParser();
            $parser->on('headers', function (\Uzulla\React\Http\Request $request, $bodyBuffer) use ($conn, $parser) {
    ...
    public function handleRequest(ConnectionInterface $conn, \Uzulla\React\Http\Request $request, $bodyBuffer)
    {
